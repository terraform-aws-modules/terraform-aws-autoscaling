...
output "default_launch_configuration_id" {
  ...
  value       = module.default.launch_configuration_id
}

output "default_launch_configuration_arn" {
  description = "The ARN of the launch configuration"
  value       = module.default.launch_configuration_arn
}

output "default_launch_configuration_name" {
  description = "The name of the launch configuration"
  value       = module.default.launch_configuration_name
}

# External
output "external_launch_configuration_id" {
  description = "The ID of the launch configuration"
  value       = module.external.launch_configuration_id
}

output "external_launch_configuration_arn" {
  description = "The ARN of the launch configuration"
  value       = module.external.launch_configuration_arn
}

output "external_launch_configuration_name" {
  description = "The name of the launch configuration"
  value       = module.external.launch_configuration_name
}

# Complete
output "complete_launch_configuration_id" {
  description = "The ID of the launch configuration"
  value       = module.complete.launch_configuration_id
}

output "complete_launch_configuration_arn" {
  description = "The ARN of the launch configuration"
  value       = module.complete.launch_configuration_arn
}

output "complete_launch_configuration_name" {
  description = "The name of the launch configuration"
  value       = module.complete.launch_configuration_name
}

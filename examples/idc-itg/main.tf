...
module "idc_itg" {
  ...
  ignore_desired_capacity_changes                       = true # This parameter will be overrided by ignore_desired_capacity_and_target_group_arns_changes
  ignore_desired_capacity_and_target_group_arns_changes = true
...
module "step_scaling_alarm" {
  ...
  alarm_actions = [module.idc_itg.autoscaling_policy_arns["scale-out"]]
}

...
| <a name="input_ignore_desired_capacity_and_target_group_arns_changes"></a> [ignore\_desired\_capacity\_and\_target\_group\_arns\_changes](#input\_ignore\_desired\_capacity\_and\_target\_group\_arns\_changes) | Determines whether the both `desired_capacity` and `target_group_arns` value are ignored after initial apply. If true, this variable overrides `ignore_desired_capacity_changes` | `bool` | `false` | no |
